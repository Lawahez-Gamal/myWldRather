...
class QuestionDetails extends Component {
    ...
    render() {
        ...
        return(
            ...
            <div className='QuestionDetails-unanswered-card-container'>
                <Card fluid raised style={{height:'230px'}}>
                    ...
                    <Card.Content className='QuestionDetails-unanswered-card-content'>
            ...
            : (<div className='QuestionDetails-container'>
                <div className='QuestionDetails-answered-card-container'>
                    <Card fluid raised style={{height:'340px'}}>
                        ...
                        <Card.Content className='QuestionDetails-answered-card-content'>
