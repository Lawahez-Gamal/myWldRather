...
import { Card, Divider, Dropdown, Button } from 'semantic-ui-react'
            ...
            <Card fluid raised style={{height:'360px'}}>
                <div style={{height:'80px',justifyContent:'center',alignContent:'center',textAlign:'center',background:"#f1f1f1"}}>
                    <Card.Content style={{display:'flex',flexDirection:'column'}}>
                        <Card.Header style={{flex:'70%',marginTop:2}} className='ui header' textAlign='center'>Would You Rather !</Card.Header>
                        <Card.Description style={{flex:'30%'}}textAlign='center'>Please sign in first</Card.Description>
                    </Card.Content>
                </div>
                <div>
                    <Divider fitted/>
                ...
                <div>
                    <p style={{textAlign:'center',color:"green", fontSize:'18px', fontWeight:'bold'}}>Sign In</p>
                </div>
                <div>
                ...
                <div>
                    <Button fluid color='violet' style={{ width:'95%',justifyContent:'center',marginTop:'20px', marginBottom:'20px',marginLeft:9}} onClick={this.handleLogin}>Sign In</Button>
                </div>
            </Card>
            </div>
        </div>
